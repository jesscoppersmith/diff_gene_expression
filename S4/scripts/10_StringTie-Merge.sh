#!/bin/bash
#SBATCH --job-name="StringTie-merge-e"
...
MERGELIST=/home/jcoppersmith/data/src/diff_gene_exp/S4_DGE/S4mergelist-e.txt
OUTPUT=/home/jcoppersmith/data/src/diff_gene_exp/S4_DGE/stringtie-merge_out/S4_merged-e.gtf
GFF_IN=/home/jcoppersmith/data/src/reference_genomes/S4Sm_genomic.gff
ABUND_OUT=/home/jcoppersmith/data/src/diff_gene_exp/S4_DGE/stringtie-merge_out/S4_merged_abund-e.txt
...
#Mergelist is a txt file with the file names and locations of the gtf files created in the previous step, StringTie-e.
...
#Rerunning the merge step with the stringTie output using the -e flag
