...
OUTPUT_DIR=/home/jcoppersmith/data/src/diff_gene_exp/S4_DGE/samtools_out
threads=16

file=`ls $INPUT_DIR/*aligned.bam | awk -v line=$SLURM_ARRAY_TASK_ID '{if (NR == line) print $0}'`
base=`basename ${file} .aligned.bam`

samtools stats $file > $OUTPUT_DIR/${base}.aligned.bam.stats
